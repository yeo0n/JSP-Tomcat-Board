...
<body>
	...
	//bbsID를 초기화
	// bbsID라는 데이터가 넘어오면 캐스팅하여 변수에 담음
	int bbsID = 0;
	...
	//유효한 글이라면 구체적인 정보를 bbs 인스턴스에 담기
	...
	<div class="container">
		<div class="row">
				<table class="table table-striped" style="text-align: center; border: 1px solid #ddddd">
					<thead>
						<tr>
							<th colspan="3" style="background-color: #eeeee; text-align: center;">게시판 글쓰기 양식</th>
						</tr>
					</thead>
					<tbody>
						<tr>
				...
				<div class="text-end">
					...
					%>
					<a href="update.jsp?bbsID=<%=bbsID%>" class="btn btn-primary">수정</a> <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%=bbsID%>"
